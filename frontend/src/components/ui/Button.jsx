...
const variants = {
  ...
  secondary: "bg-[var(--surface-2)] text-[var(--text)] hover:bg-[var(--surface-2)] focus:ring-slate-300",
  ghost: "bg-transparent text-[var(--text-muted)] hover:bg-[var(--surface-2)] focus:ring-slate-300",
