...
//                   <ProductImage src={resolveImageUrl(product?.ProductImage?.[0])} alt={product.category} className='cursor-pointer objeect-scale-down hover:scale-110 transition-all mix-blend-multiply h-full' ratio='1:1' fit='contain' />
//                   </div>
//                   <div className='p-4 mx-auto gap-3 '>
